<template>
    <el-dialog custom-class='FixedAssets_dialog' v-model="FixedAssets_dialog" :title=" FixedAssetsUserName + ' - 固定资产信息' " :close-on-click-modal='false' draggable width="55%" top='1vh'>
